...
$(document).ready(function () {
    ...
    function getNotificationHTML(obj) {
       ...
       // Server Time is UTC, Replacing T to Z for Javascript to understand it as GMT.
        var d = new Date(obj.schedule_start_datetime.replace("T","Z"));
    ...
    //Added to serialize forms to object in JSON Packet
...
//Format Number as Digits with Commas.
